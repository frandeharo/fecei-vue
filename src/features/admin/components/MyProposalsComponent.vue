...
<template>
  <div>
    <!-- <DataTable :value="data"  stripedRows tableStyle="min-width: 50rem" tableClass="w-full" paginator :rows="30"
    dataKey="id" filterDisplay="row"  selectionMode="single" @rowSelect="router.push({name:'edit-proposal', params:{id:$event.data.id}})"
  > -->
    <DataTable
      :value="data"
      dataKey="id"
